...
export default function ParallaxHero() {
  ...
  return (
    <section id="hero-section" className="relative h-screen min-h-[600px] overflow-hidden">
      {/* Parallax Background */}
      <div className="absolute inset-0 w-full h-full transform-gpu will-change-transform translate-y-0 scale-110">
        ...
        <video
          ...
          style={{ transform: 'scale(1.1)' }} // Slight zoom for parallax effect
        >
