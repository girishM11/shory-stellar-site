...
import { testimonialsBg } from '@/assets/images';
        ...
        <div className="max-w-4xl mx-auto animate-on-scroll">
          <div className="relative h-[400px] md:h-[300px]">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className={`absolute inset-0 transition-all duration-700 flex flex-col md:flex-row items-center gap-8 p-6 md:p-8 rounded-lg bg-white/5 backdrop-blur-sm ${
                  index === active 
              ...
              >
                ...
                <div className="text-center md:text-left">
                  <div className="mb-4 flex justify-center md:justify-start">
                    {[...Array(5)].map((_, i) => (
                      <span key={i} className={i < testimonial.rating ? 'text-gold-300' : 'text-gray-600'}>
                        ★
                      </span>
                    ))}
                  </div>
